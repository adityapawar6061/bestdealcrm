<div class="page-header">
    <h4><i class="bi bi-clipboard2-check me-2"></i>Review 4 - Dispatch Decision</h4>
    <small class="text-muted">Underwriting-approved cases that need admin decision: send to Dispatch or Reject</small>
</div>
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-info"><?= humanStatus($lead['workflow_stage']) ?></span></td>
                        <td><small class="text-muted"><?= formatDate($lead['updated_at'] ?? '') ?></small></td>
                        <td><a href="/bestdealcrm/admin/review4/<?= $lead['id'] ?>" class="btn btn-sm btn-primary">Review</a></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
