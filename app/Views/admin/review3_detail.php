<div class="page-header d-flex justify-content-between align-items-center">
    ...
    <a href="/bestdealcrm/admin/review3" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i> Back</a>
</div>
...
<div class="row g-4">
    <div class="col-md-8">
        ...
        <div class="table-container">
            <h6 class="fw-bold mb-3">Admin Decision - Send to Underwriting?</h6>
            <form id="review3Form">
                <?= csrfField() ?>
                <input type="hidden" name="lead_id" value="<?= $lead['id'] ?>">
                <div class="mb-3">
                    <label class="form-label small fw-semibold">Admin Remark</label>
                    <textarea name="admin_approval3_remark" class="form-control" rows="3" placeholder="Add your remark..."></textarea>
                </div>
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-success" onclick="processReview3('approve_to_underwriting')">
