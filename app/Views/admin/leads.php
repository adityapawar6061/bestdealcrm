...
<head>
    ...
    <title>Leads - BestDeal CRM</title>
...
<body>
    <aside class="sidebar">
        ...
        <nav class="mt-3">
            ...
            <a href="/bestdealcrm/admin/leads" class="nav-link active"><i class="bi bi-list-ul"></i> All Leads</a>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            <h4 class="mb-4"><i class="bi bi-list-ul me-2"></i>All Leads</h4>
            <div class="table-container">
                <div class="table-responsive">
                    <table class="table table-hover table-sm align-middle mb-0">
                        <thead class="table-light">
                            <tr><th>#</th><th>Customer</th><th>Mobile</th><th>Location</th><th>Bank</th><th>Assigned To</th><th>Stage</th><th>Created</th></tr>
                        </thead>
                        <tbody>
                            <?php if (empty($leads)): ?>
