        ...
        <div class="d-flex align-items-start gap-3 p-3 border-bottom <?= $notif['is_read'] ? '' : 'bg-light' ?>" id="notif-<?= $notif['id'] ?>">
            ...
            <div class="flex-grow-1">
                ...
                <?php if ($notif['related_lead_id']): ?>
                    <a href="/bestdealcrm/login-agent/cases/<?= $notif['related_lead_id'] ?>/pre-login" class="ms-2 small">View Case</a>
                <?php endif; ?>
            </div>
...
async function markRead(id) {
    ...
    await ajaxPost('/bestdealcrm/login-agent/notifications/read', fd);
